                ...
                <Row>
                    <Col md={8}>
                        <ListGroup className='mb-2'>
                            ...
                            <ListGroup.Item>
                                <b>Address:</b> {shippingAddress.address+shippingAddress.city+', '+shippingAddress.postalCode+', '+shippingAddress.country}
                            </ListGroup.Item>
                    ...
                    <Col md={4}>
                        <Card className='mb-2'>
                            ...
                            <Card.Footer>
                                <Button className='m-auto w-100' onClick={handleClickPlaceOrder}>Place Order</Button>
